...
public class GuessDatabaseClient {
	private static String service_url = "http://localhost:8085/restlet/guessit/database";
	...
	public static void main(String[] args) throws Exception {
	 ...
	 JsonRepresentation newResult = new JsonRepresentation(result);
		...
		//JsonRepresentation newResult2 = new JsonRepresentation(result2);
